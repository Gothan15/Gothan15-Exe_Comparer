 ...
 */
export function compareSizes(content1: ArrayBuffer, content2: ArrayBuffer): boolean {
 ...
 */
export function findByteDifferences(content1: ArrayBuffer, content2: ArrayBuffer): number[] {
 ...
 */
export function calculateSimilarity(content1: ArrayBuffer, content2: ArrayBuffer): number {
